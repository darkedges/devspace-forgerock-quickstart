...
export AM_KEYSTORE_DEFAULT_ENTRY_PASSWORD=${AM_KEYSTORE_DEFAULT_ENTRY_PASSWORD:-$(cat $SECRETS_PATH/secrets/default/.keypass)}
export AM_KEYSTORE_DEFAULT_PASSWORD=${AM_KEYSTORE_DEFAULT_PASSWORD:-$(cat $SECRETS_PATH/secrets/default/.storepass)}
